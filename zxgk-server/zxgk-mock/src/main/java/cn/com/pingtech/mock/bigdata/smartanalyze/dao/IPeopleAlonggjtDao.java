 ...
 */
@Repository
public interface IPeopleAlonggjtDao {

    List<PeopleAlonggjtVo> findPage(@Param("page") Page<PeopleAlonggjtVo> page);

    int count(@Param("page") Page<PeopleAlonggjtVo> page);
}
