 ...
 */
@Repository
public interface IPeopleAlongDao {

    List<PeopleAlongVo> findPage(@Param("page") Page<PeopleAlongVo> page);

    int count(@Param("page") Page<PeopleAlongVo> page);

    List<PeopleAlongVo> findList(PeopleAlongVo params);

    List<PeopleAlongVo> findPageDetail(@Param("page") Page<PeopleAlongVo> page);

    int countDetail(@Param("page") Page<PeopleAlongVo> page);
}
